  ...
  <Layout>
    ...
    <section className="intro">
      <div className="intro__container container">
        ...
        <article className="intro__article">
          <span className="fancy-subtitle fancy-subtitle--left fancy-subtitle--absolute">
            THE ISSUE
          </span>
          <h2 className="intro__heading big-text">
    ...
    <section className="mission">
      <div className="mission__container container">
        <h2 className="fancy-subtitle fancy-subtitle--light">WHAT WE DO</h2>
        ...
        <div className="mission__articles">
        ...
        <div className="stories__content">
          <div className="stories__story">
            <h3 className="big-text big-text--light">
              ...
              gave me assistance, I was really struggling with this issue.
            </h3>
            <p className="stories__desc font-light font-light--light">
